...
const PAUSE_DURATION_MICROSECONDS = 1750;
...
describe('Basic cross-platform We Vote test',  () => {
  it('can visit the different pages in the app', async () => {
    ...
    // //////////////////////
    // Set location and election
    if (isDesktopScreenSize) {
      await simpleClick('changeAddressOrElectionHeaderBar'); // Opens the "Enter Your Full Address" link
      await browser.pause(PAUSE_DURATION_MICROSECONDS);
      ...
      await browser.pause(PAUSE_DURATION_MICROSECONDS)
      await simpleClick('changeAddressOnlyHeaderBar'); // Opens the "Enter Your Full Address" link
      await browser.pause(PAUSE_DURATION_MICROSECONDS);  
    ...
    // const exampleCandidate = 'wv02cand40159'; // a weVote ID
    // if (isDesktopScreenSize) {
    //   await simpleClick('ballotBadgeDesktop-Federal');
    ...
    // // Visit Measure Page
    // if (isDesktopScreenSize) {
    //   await simpleClick('ballotBadgeDesktop-Measure'); // Click on Measure Page
    //   await browser.pause(PAUSE_DURATION_MICROSECONDS);
