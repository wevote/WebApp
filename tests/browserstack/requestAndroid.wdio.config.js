...
exports.config = {
  ...
  updateJob: false,
  specs: [
    './tests/browserstack/specs/requestMainTest.js',
  ],
  ...
  capabilities: [
    {
      name: 'requestMainTest-AndroidSamsungGalaxyS9PlusAndroid',
    ...
    {
      name: 'requestMainTest-AndroidSamsungGalaxyJ7PrimeAndroid',
      build: buildNameForDisplay,
    ...
    {
      name: 'requestMainTest-AndroidSamsungGalaxyS8Android',
      build: buildNameForDisplay,
    ...
    {
      name: 'requestMainTest-AndroidGooglePixel4Android',
      build: buildNameForDisplay,
    ...
    {
      name: 'requestMainTest-AndroidGooglePixel3Android',
      build: buildNameForDisplay,
