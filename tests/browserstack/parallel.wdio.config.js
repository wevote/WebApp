...
exports.config = {
  ...
  capabilities: [
    {
      name: '%scriptNameMainTest: %device0',
    ...
    {
      name: '%scriptNameMainTest: %device1',
      build: buildNameForDisplay,
      device: '%device1',
      os: %os1,
    ...
    {
      name: '%scriptNameMainTest: %device2',
      build: buildNameForDisplay,
      device: '%device2',
      os: %os2,
    ...
    {
      name: '%scriptNameMainTest: %device3',
      build: buildNameForDisplay,
      device: '%device3',
      os: %os3,
    ...
    {
      name: '%scriptNameMainTest: %device4',
      build: buildNameForDisplay,
      device: '%device4',
      os: %os4,
