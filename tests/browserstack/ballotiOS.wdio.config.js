...
exports.config = {
  ...
  capabilities: [
    {
      name: 'ballotMainTest-iOSiPhoneXRiPhone',
    ...
    {
      name: 'ballotMainTest-iOSiPhone8iPhone',
      build: buildNameForDisplay,
      device: 'iPhone 8',
      os: '',
      os_version: '13',
    ...
    {
      name: 'ballotMainTest-iOSiPhone8PlusiPhone',
      build: buildNameForDisplay,
    ...
    {
      name: 'ballotMainTest-iOSiPhone6SiPhone',
      build: buildNameForDisplay,
      device: 'iPhone 6S',
      os: '',
      os_version: '12',
    ...
    {
      name: 'ballotMainTest-iOSiPad6thiPad',
      build: buildNameForDisplay,
      device: 'iPad 6th',
      os: '',
      os_version: '11',
