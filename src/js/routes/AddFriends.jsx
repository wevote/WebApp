	...
	render () {
		return <div>
			<div className="bs-container-fluid bs-well u-gutter-top--small fluff-full1">
				...
				<h2 className="bs-text-center">Add Friends</h2>
				<div>
					<label htmlFor="last-name">Include a Message <span className="small">(Optional)</span></label><br />
					<input type="text" name="add_friends_message" className="bs-form-control"
						   defaultValue="Please join me in preparing for the upcoming election." /><br />
					<Input type="text" addonBefore="@" name="email_address" className="bs-form-control"
