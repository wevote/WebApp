...
export default class IntroOpinionsPage extends Component {
  ...
  render () {
    ...
    const { voter_guides_to_follow_all, ballot_has_guides } = this.state;
    ...
    return (
      <div className="container-fluid">
        ...
        <div className="well well-100">
          <p>
            You have organizations and friends you trust when it comes time to
            vote. Follow them so you can see what they endorse on your ballot.
          </p>
