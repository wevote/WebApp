      ...
      <Helmet title="Welcome to We Vote" />
        <div className="intro-story container-fluid well u-inset--md">
          ...
          {this.state.voter.signed_in_facebook ?
            null :
            <div className="row">
              <div id = "facebook-intro-connect" className="col-md-4 col-md-offset-4 xs-block form-group">
                <FacebookSignIn /><br />
          ...
          {this.state.voter.signed_in_twitter ?
            null :
            <div className="row">
              <div id = "twitter-intro-connect" className="col-md-4 col-md-offset-4 xs-block form-group">
                <TwitterSignIn /><br />
