...
export default class VerifyFriendRequestProcess extends Component {
  static propTypes = {
  ...
  componentDidMount () {
    ...
    console.log("VerifyFriendRequestProcess, componentDidMount, this.props.params.email_secret_key: ", email_secret_key);
