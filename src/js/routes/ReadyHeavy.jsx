...
class ReadyHeavy extends Component {
  constructor (props) {
    super(props);
    this.state = {
  ...
  componentDidCatch (error, info) {
    console.log('ReadyHeavy.jsx caught: ', error, info.componentStack);
  }
  ...
  static getDerivedStateFromError (error) {       // eslint-disable-line no-unused-vars
    console.log('Error in ReadyHeavy: ', error);
  ...
  onIssueStoreChange () {
    ...
    // console.log('ReadyHeavy, onIssueStoreChange, issuesDisplayDecisionHasBeenMade: ', issuesDisplayDecisionHasBeenMade);
  ...
  goToBallot = () => {
    console.log('goToBallot ENTRY from ready heavy');
    historyPush('/ballot');
  }
  ...
  render () {
    renderLog('ReadyHeavy');  // Set LOG_RENDER_EVENTS to log all renders
    const {
...
export default withStyles(styles)(ReadyHeavy);
