...
module.exports = {
  ...
  WE_VOTE_HOSTNAME: "10.0.2.2:3000",  // This should be without "http...". This is "WeVote.US" on live server.
  // WE_VOTE_HOSTNAME: "localhost:3000",  // This should be without "http...". This is "WeVote.US" on live server.

  WE_VOTE_SERVER_ROOT_URL: "http://10.0.2.2:8000/",
  WE_VOTE_SERVER_ADMIN_ROOT_URL: "http://10.0.2.2:8000/admin/",
  WE_VOTE_SERVER_API_ROOT_URL: "http://10.0.2.2:8000/apis/v1/",
