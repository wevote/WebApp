    ...
    if (isIPhone4in()) {
      ...
      switch (page) {
        case CordovaPageConstants.ballotLgHdrWild:
          return showBallotDecisionsTabs() ? '48px' : '32px';
        case CordovaPageConstants.ballotSmHdrWild:
          return '141px';  // $body-padding-top-no-decision-tabs
        ...
        case CordovaPageConstants.measureWild:
          return '42px';
        case CordovaPageConstants.moreAbout:
          return '22px';
        case CordovaPageConstants.moreTerms:
          return '40px';
        case CordovaPageConstants.moreTools:
          return '44px';
        ...
        case CordovaPageConstants.welcomeWild:
          return '10px';
        case CordovaPageConstants.wevoteintroWild:
          return '18px';
        default:
          return '0px';
      }
      ...
      switch (page) {
        case CordovaPageConstants.ballotLgHdrWild:
          return showBallotDecisionsTabs() ? '52px' : '36px';
        case CordovaPageConstants.ballotSmHdrWild:
          return '136px';
        case CordovaPageConstants.ballotVote:
          return isSignedIn ? '149px' : '148px';
        case CordovaPageConstants.candidate:
          return '42px';
        case CordovaPageConstants.candidateWild:
          return '57px';
        ...
        case CordovaPageConstants.settingsSubscription:
          return '72px';
        case CordovaPageConstants.settingsVoterGuideLst:
          return '73px';
        case CordovaPageConstants.settingsWild:
          return '76px';
        case CordovaPageConstants.twitterSignIn:
        ...
        case CordovaPageConstants.voterGuideCreatorWild:
          return '10px'; // $headroom-wrapper-webapp__voter-guide
        case CordovaPageConstants.voterGuideWild:
          return '55px';
        case CordovaPageConstants.welcomeWild:
          return '10px';
        case CordovaPageConstants.wevoteintroWild:
      ...
      switch (page) {
        case CordovaPageConstants.ballotLgHdrWild:
          return showBallotDecisionsTabs() ? '35px' : '19px';
        case CordovaPageConstants.ballotSmHdrWild:
          return '148px';
        case CordovaPageConstants.ballotVote:
          return '157px';
      ...
      switch (page) {
        case CordovaPageConstants.ballotLgHdrWild:
          return showBallotDecisionsTabs() ? '58px' : '41px';
        case CordovaPageConstants.ballotSmHdrWild:
          return '169px';
        case CordovaPageConstants.ballotVote:
          return isSignedIn ? '163px' : '165px';
        case CordovaPageConstants.candidate:
          return '56px';
        case CordovaPageConstants.candidateWild:
          return '72px';
        ...
        case CordovaPageConstants.officeWild:
          return '101px';
        case CordovaPageConstants.opinions:
          return '10px';
        case CordovaPageConstants.opinionsPubFigs:
          return '25px';
        case CordovaPageConstants.ready:
          return '74px';
        case CordovaPageConstants.settingsAccount:
      ...
      switch (page) {
        ...
        case CordovaPageConstants.ballotSmHdrWild:
          return '161px';
        case CordovaPageConstants.ballotVote:
          return isSignedIn ? '165px' : '173px';
        case CordovaPageConstants.candidate:
          return '56px';
        case CordovaPageConstants.candidateWild:
          return '96px';    // 53 t 96 for 12 max pro
        case CordovaPageConstants.friends:
          return '157px';
        case CordovaPageConstants.friendsCurrent:
          return '157px';
        case CordovaPageConstants.friendsSentRequest:
          return '69px';
        case CordovaPageConstants.measureWild:
          return '56px';
        case CordovaPageConstants.moreAbout:
          return '22px';
        case CordovaPageConstants.moreFaq:
          return '74px';
        case CordovaPageConstants.moreTerms:
          return '91px';
        case CordovaPageConstants.moreTools:
          return '44px';
        case CordovaPageConstants.news:
          return '91px';
        case CordovaPageConstants.officeWild:
          return '120px';    // 76 to 120 for 12 max pro
        case CordovaPageConstants.opinionsPubFigs:
          return '92px';
        case CordovaPageConstants.ready:
          return '93px';   // 73 -> 93 for 12 max pro, fine on 11 Pro Max
        case CordovaPageConstants.settingsAccount:
          return '84px';
        case CordovaPageConstants.settingsHamburger:
          return '81px';
        case CordovaPageConstants.settingsNotifications:
          return '79px';     // 79 -> 105 for 12 max pro, fine on
        case CordovaPageConstants.settingsSubscription:
          return '90px';
        case CordovaPageConstants.settingsVoterGuideLst:
          return '98px';
        case CordovaPageConstants.settingsWild:
          return '63px';
        case CordovaPageConstants.twitterInfoPage:
          return '26px';
        case CordovaPageConstants.twitterHandleLanding:
          return '24px';  // Was 88, but mixed twitterInfoPage and twitterHandleLanding reported 9/22/21
        case CordovaPageConstants.twitterSignIn:
          return '50px';
        case CordovaPageConstants.values:
          return '40px';      // 3 -> 93 for 12 max pro, fine on 11
        case CordovaPageConstants.valuesList:
          return '92px';
        case CordovaPageConstants.voterGuideCreatorWild:
          return '10px'; // $headroom-wrapper-webapp__voter-guide
        case CordovaPageConstants.voterGuideWild:
      ...
      switch (page) {
        ...
        case CordovaPageConstants.voterGuideCreatorWild:
          return '10px'; // $headroom-wrapper-webapp__voter-guide
        case CordovaPageConstants.voterGuideWild:
          return '75px'; // See cordovaVoterGuideTopPadding instead
        case CordovaPageConstants.welcomeWild:
          return '22px';
        case CordovaPageConstants.wevoteintroWild:
          return '32px';
      ...
      switch (page) {
        case CordovaPageConstants.ballotLgHdrWild:
          return '34px';  // tested 11/3/20
        case CordovaPageConstants.ballotSmHdrWild:
          return '34px';  // tested 11/2/20
        case CordovaPageConstants.ballotVote:
          return '131px';
        case CordovaPageConstants.candidate:
          return '40px';
        case CordovaPageConstants.candidateWild:
          return '49px';  // tested 10/2/20
        case CordovaPageConstants.measureWild:
          return '67px';
        case CordovaPageConstants.moreAbout:
          return '22px';  // tested 10/1/20
        case CordovaPageConstants.moreTerms:
          return '44px';
        case CordovaPageConstants.moreTools:
          return '44px';
        case CordovaPageConstants.news:
          return '9px';   // tested 9/30/20
        case CordovaPageConstants.officeWild:
          return '106px';
        case CordovaPageConstants.opinions:
          return '14px';
        case CordovaPageConstants.ready:
          return '50px';   // tested 11/3/20
        case CordovaPageConstants.settingsAccount:
          return '85px';
        case CordovaPageConstants.settingsHamburger:
          return '45px';  // tested 10/1/20
        case CordovaPageConstants.settingsNotifications:
          return '67px';  // tested 9/30/20
        case CordovaPageConstants.settingsSubscription:
          return '87px';
        case CordovaPageConstants.settingsWild:
          return '61px';
      ...
      switch (page) {
        ...
        case CordovaPageConstants.wevoteintroWild:
          return '18px';
        case CordovaPageConstants.defaultVal:
          return '26px';
        default:
          return '0px';
      }
