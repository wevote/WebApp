...
function HeartFavoritePressed () {
  return (
    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 21.6735L10.55 20.3535C5.4 15.6835 2 12.6035 2 8.82349C2 5.74349 4.42 3.32349 7.5 3.32349C9.24 3.32349 10.91 4.13349 12 5.41349C13.09 4.13349 14.76 3.32349 16.5 3.32349C19.58 3.32349 22 5.74349 22 8.82349C22 12.6035 18.6 15.6835 13.45 20.3635L12 21.6735Z" fill={DesignTokenColors.alert400} />
    </svg>
  );
}

function HeartDislike () {
  return (
    <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
...
function HeartFavoriteToggleIcon ({ isDislike, isFavorite, voterOpposes, voterSupports }) {
  return (
    <IconContainer>
      {isDislike && (
      <Icon>
