...
//  This will start the GreenSock animation
  ...
  render () {
    return <div className="intro-story__background background--image3">
      ...
      <div ref="ballotImg1"><img className="center-block intro-story__img-height" src={"/img/global/animations/slide6.svg"}/></div>
      <div ref="header2" className="intro-story__h2">See opinions for everything<br />on your ballot.</div>
    </div>;
  }
}
