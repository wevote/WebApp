...
class VoterGuideSettingsBallotFilter extends Component {
  static propTypes = {
  ...
  render () {
    ...
    // console.log('VoterGuideSettingsBallotFilter render');
...
export default withStyles(styles)(VoterGuideSettingsBallotFilter);
