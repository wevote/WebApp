  ...
  render () {
    ...
    return (
      <header className={ isWebApp() ? "page-header" : hasIPhoneNotch() ? "page-header page-header__cordova-iphonex" : "page-header page-header__cordova" }>
        <Button className={`btn btn-sm btn-default page-header__backToButton hidden-xs ${hasIPhoneNotch() ? "page-header__backToButtonIPhoneX" : ""}`}
                onClick={ () => historyPush(backToLink) }>
          <span className="fa fa-arrow-left"/> {backToOrganizationLinkText}
        </Button>
        <Button className={`btn btn-sm btn-default page-header__backToButton visible-xs ${hasIPhoneNotch() ? "page-header__backToButtonIPhoneX" : ""}`}
                onClick={ () => historyPush(backToLink) }>
