...
import AppObservableStore, {
  messageService,
} from "../../common/stores/AppObservableStore";
...
import {
  ...
  isCordova,
  isWebApp,
} from "../../common/utils/isCordovaOrWebApp";
...
class FooterBar extends React.Component {
  ...
  componentDidMount() {
    ...
    this.appStateSubscription = messageService
      .getMessage()
      .subscribe(() => this.onAppObservableStoreChange());
    this.friendStoreListener = FriendStore.addListener(
      this.onFriendStoreChange.bind(this)
    );
    this.voterStoreListener = VoterStore.addListener(
      this.onVoterStoreChange.bind(this)
    );
    const showingOneCompleteYourProfileModal =
      AppObservableStore.showingOneCompleteYourProfileModal();
    ...
    const friendInvitationsSentToMeCount = friendInvitationsSentToMe
  ...
  onAppObservableStoreChange() {
    const showActivityTidbitDrawer =
      AppObservableStore.showActivityTidbitDrawer();
    const showingOneCompleteYourProfileModal =
      AppObservableStore.showingOneCompleteYourProfileModal();
    const showShareModal = AppObservableStore.showShareModal();
    const showSharedItemModal = AppObservableStore.showSharedItemModal();
      ...
      <FooterBarWrapper>
        <FooterContainer
          className={`u-show-mobile-tablet ${
            hideFooterBehindModal ? " u-z-index-1000" : " u-z-index-9000"
          }`}
          id="footer-container"
