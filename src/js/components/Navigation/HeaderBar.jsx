...
class HeaderBarProfilePopUp extends Component {
  constructor(props) {
    ...
    this.signOutAndHideProfilePopUp =
      this.props.signOutAndHideProfilePopUp.bind(this);
    ...
    this.transitionToYourVoterGuide =
      this.props.transitionToYourVoterGuide.bind(this);
  }
  ...
  render() {
    ...
    const { classes, isWelcomeMobilePage, voter, profilePopUpOpen } =
      this.props;
    ...
    const popUpOpen = (function opener() {
      if (profilePopUpOpen) {
        return isWebApp()
          ? `${
              isWelcomeMobilePage
                ? "profile-menu-welcome-mobile-page--open"
                : "profile-menu--open"
            }`
          : "profile-pop-up-menu-cordova--open";
      }
      return "";
    })();
    ...
    return (
      <div className={popUpOpen}>
        ...
        <ProfileMenu
          ...
          style={
            isCordova() && window.innerWidth > 1000 ? { left: "12px" } : {}
          } // Android Nexus 10 in Cordova
        >
          <span className="we-vote-promise">
          ...
          <ul className="nav flex-column">
              ...
              <li className="d-none d-sm-block">
                <ListItemWrapper>
                  ...
                  >
                    ...
                    >
                      <span className="header-slide-out-menu-text-left">
                        Your Settings
                      </span>
                    </Button>
                  </Link>
            ...
            <li className={isCordova() ? "navli" : "navli d-block d-sm-none"}>
              <ListItemWrapper>
                <Link
                  id="profilePopUpYourSettingsMobile"
                  onClick={this.hideProfilePopUp}
                  to="/settings/hamburger"
                >
                  <Button
                    variant="text"
                    color="primary"
