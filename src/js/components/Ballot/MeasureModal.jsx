...
export default class MeasureModal extends Component {
  ...
  componentDidMount () {
    ...
    const measureSupportProps = SupportStore.get(this.props.measure.we_vote_id);
    if (measureSupportProps !== undefined) {
      this.setState({ measureSupportProps });
    }
          ...
          { this.props.measure ? (
            <section className="card">
              ...
              <ItemSupportOpposeCounts
                we_vote_id={this.props.measure.we_vote_id}
                  ...
                  <p className="card__no-additional">{NO_VOTER_GUIDES_TEXT}</p> : (
                    <div>
                      ...
                      <div className="card__additional-text">
                        ...
                        {" "}
                        to the voter guides of organizations and people you trust.
                        <br />
                        <strong>Ignore</strong>
                        {" "}
                        voter guides that don&apos;t share your values.
                      </div>
                      <GuideList
                        ballotItemWeVoteId={this.props.measure.we_vote_id}
