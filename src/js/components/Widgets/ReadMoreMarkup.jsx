...
export default class ReadMoreMarkup extends Component {
  static propTypes = {
    markupToDisplay: PropTypes.node.isRequired,
  ...
  render () {
    renderLog('ReadMoreMarkup');  // Set LOG_RENDER_EVENTS to log all renders
    const { markupToDisplay } = this.props;
    let {
      link_text: linkText, numberOfLines, collapse_text: collapseText,
    } = this.props;
