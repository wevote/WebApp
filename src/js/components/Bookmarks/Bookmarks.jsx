...
import EditAddress from "../Widgets/EditAddress";
import { historyPush } from "../../utils/cordovaUtils";
import LoadingWheel from "../LoadingWheel";
import { renderLog } from "../../utils/logging";
import SelectAddressModal from "../Ballot/SelectAddressModal";
...
export default class Bookmarks extends Component {
  ...
  render () {
    ...
    const electionTooltip = election_day_text ? (
      <Tooltip id="tooltip">
        Election day
        {moment(election_day_text).format("MMM Do, YYYY")}
      </Tooltip>
    ) : <span />;
    const voter_address_object = VoterStore.getAddressObject();

    return (
      <div className="ballot">
        { this.state.showSelectAddressModal ? (
          <SelectAddressModal
            show={this.state.showSelectAddressModal}
            toggleFunction={this.toggleSelectAddressModal}
          />
        ) : null }
