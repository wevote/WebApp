...
## Viewing production server logs in AWS
This is very rarely needed, but if you need it talk to you team lead or Dale.

## Improving Rendering Efficiency

Excessive component renders can make the app slow, so we need to avoid them.  React will not update the DOM if none of the data changed
