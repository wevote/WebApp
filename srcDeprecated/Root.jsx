...
import News from './pages/Activity/News';
const AddCandidateForExtension = React.lazy(() => import('./pages/Ballot/AddCandidateForExtension'));
const Ballot = React.lazy(() => import('./pages/Ballot/Ballot'));
// const BallotIndex = React.lazy(() => import('./pages/Ballot/BallotIndex'));
const Candidate = React.lazy(() => import('./pages/Ballot/Candidate'));
const CandidateForExtension = React.lazy(() => import('./pages/Ballot/CandidateForExtension'));
const Measure = React.lazy(() => import('./pages/Ballot/Measure'));
const Office = React.lazy(() => import('./pages/Ballot/Office'));
const FacebookInvitableFriends = React.lazy(() => import('./pages/FacebookInvitableFriends'));
const Friends = React.lazy(() => import('./pages/Friends/Friends'));
const HowItWorks = React.lazy(() => import('./pages/HowItWorks'));
const FriendInvitationOnboarding = React.lazy(() => import('./pages/Intro/FriendInvitationOnboarding'));
const GetStarted = React.lazy(() => import('./pages/Intro/GetStarted'));
const Intro = React.lazy(() => import('./pages/Intro/Intro'));
const IntroNetwork = React.lazy(() => import('./pages/Intro/IntroNetwork'));
const SampleBallot = React.lazy(() => import('./pages/Intro/SampleBallot'));
const About = React.lazy(() => import('./pages/More/About'));
const AbsenteeBallot = React.lazy(() => import('./pages/More/AbsenteeBallot'));
const Attributions = React.lazy(() => import('./pages/More/Attributions'));
const Credits = React.lazy(() => import('./pages/More/Credits'));
const Donate = React.lazy(() => import('./pages/More/Donate'));
const DonateThankYou = React.lazy(() => import('./pages/More/DonateThankYou'));
const ElectionReminder = React.lazy(() => import('./pages/More/ElectionReminder'));
const Elections = React.lazy(() => import('./pages/More/Elections'));
const ExtensionSignIn = React.lazy(() => import('./pages/More/ExtensionSignIn'));
const FacebookRedirectToWeVote = React.lazy(() => import('./pages/More/FacebookRedirectToWeVote'));
const FAQ = React.lazy(() => import('./pages/More/FAQ'));
const Pricing = React.lazy(() => import('./pages/More/Pricing'));
const Privacy = React.lazy(() => import('./pages/More/Privacy'));
const ProcessingDonation = React.lazy(() => import('./pages/More/ProcessingDonation'));
const RegisterToVote = React.lazy(() => import('./pages/More/RegisterToVote'));
// const ScratchPad = React.lazy(() => import('./pages/ScratchPad'));
const SearchPage = React.lazy(() => import('./pages/More/SearchPage'));
const TermsOfService = React.lazy(() => import('./pages/More/TermsOfService'));
const VerifyRegistration = React.lazy(() => import('./pages/More/VerifyRegistration'));
const WeVoteBallotEmbed = React.lazy(() => import('./pages/More/WeVoteBallotEmbed'));
const Opinions2020 = React.lazy(() => import('./pages/Opinions2020'));
const OpinionsFollowed = React.lazy(() => import('./pages/OpinionsFollowed'));
const OpinionsIgnored = React.lazy(() => import('./pages/OpinionsIgnored'));
const PageNotFound = React.lazy(() => import('./pages/PageNotFound'));
const AppleSignInProcess = React.lazy(() => import('./pages/Process/AppleSignInProcess'));
const FacebookLandingProcess = React.lazy(() => import('./pages/Process/FacebookLandingProcess'));
const FriendInvitationByEmailVerifyProcess = React.lazy(() => import('./pages/Process/FriendInvitationByEmailVerifyProcess'));
const SignInEmailProcess = React.lazy(() => import('./pages/Process/SignInEmailProcess'));
const SignInJumpProcess = React.lazy(() => import('./pages/Process/SignInJumpProcess'));
const TwitterSignInProcess = React.lazy(() => import('./pages/Process/TwitterSignInProcess'));
const VerifyEmailProcess = React.lazy(() => import('./pages/Process/VerifyEmailProcess'));
// const GetReady = React.lazy(() => import('./pages/GetReady'));
const Ready = React.lazy(() => import('./pages/Ready'));
const ReadyRedirect = React.lazy(() => import('./pages/ReadyRedirect'));
const Register = React.lazy(() => import('./pages/Register'));
const ClaimYourPage = React.lazy(() => import('./pages/Settings/ClaimYourPage'));
const HamburgerMenu = React.lazy(() => import('./pages/Settings/HamburgerMenu'));
const Location = React.lazy(() => import('./pages/Settings/Location'));
const SettingsDashboard = React.lazy(() => import('./pages/Settings/SettingsDashboard'));
const SettingsMenuMobile = React.lazy(() => import('./pages/Settings/SettingsMenuMobile'));
const VoterGuideListDashboard = React.lazy(() => import('./pages/Settings/VoterGuideListDashboard'));
const VoterGuideSettingsDashboard = React.lazy(() => import('./pages/Settings/VoterGuideSettingsDashboard'));
const VoterGuideSettingsMenuMobile = React.lazy(() => import('./pages/Settings/VoterGuideSettingsMenuMobile'));
const VoterGuidesMenuMobile = React.lazy(() => import('./pages/Settings/VoterGuidesMenuMobile'));
const SharedItemLanding = React.lazy(() => import('./pages/SharedItemLanding'));
const TwitterHandleLanding = React.lazy(() => import('./pages/TwitterHandleLanding'));
const Values = React.lazy(() => import('./pages/Values'));
const ValuesList = React.lazy(() => import('./pages/Values/ValuesList'));
const VoterGuidesUnderOneValue = React.lazy(() => import('./pages/Values/VoterGuidesUnderOneValue'));
const Vote = React.lazy(() => import('./pages/Vote'));
const OrganizationVoterGuide = React.lazy(() => import('./pages/VoterGuide/OrganizationVoterGuide'));
const OrganizationVoterGuideCandidate = React.lazy(() => import('./pages/VoterGuide/OrganizationVoterGuideCandidate'));
const OrganizationVoterGuideMeasure = React.lazy(() => import('./pages/VoterGuide/OrganizationVoterGuideMeasure'));
const OrganizationVoterGuideMobileDetails = React.lazy(() => import('./pages/VoterGuide/OrganizationVoterGuideMobileDetails'));
const OrganizationVoterGuideOffice = React.lazy(() => import('./pages/VoterGuide/OrganizationVoterGuideOffice'));
const VerifyThisIsMe = React.lazy(() => import('./pages/VoterGuide/VerifyThisIsMe'));
const WelcomeForCampaigns = React.lazy(() => import('./pages/WelcomeForCampaigns'));
const WelcomeForOrganizations = React.lazy(() => import('./pages/WelcomeForOrganizations'));
const WelcomeForVoters = React.lazy(() => import('./pages/WelcomeForVoters'));
...
const routes = () => {
  ...
  console.log('Root.jsx pages immediately prior to instantiation');
  return (
    <>
      <Route exact path="/">
        {(function redirect () {
